    ...
    methods: {
                ...
                axios
                    ...
                    .catch((error) => {
                        if (!axios.isCancel(error)) {
                            context.loading = false
                            HuberwayCMS.handleError(error.response.data)
                        }
                    })
            }
        },
        ...
        selectProductVariant: function (product, refOptions) {
            ...
            if (_.isEmpty(product) && product.is_out_of_stock) {
                HuberwayCMS.showError(context.__('order.cant_select_out_of_stock_product'))
                return false
            }
        ...
        checkDataBeforeCreateOrder: function (data = {}, onSuccess = null, onError = null) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (res.data.error) {
                        HuberwayCMS.showError(res.data.message)
                        if (onError) {
                            onError()
                        }
                    } else {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (res.data.error) {
                        ...
                        HuberwayCMS.showSuccess(res.data.message)
                        if (paid) {
                ...
                .catch((res) => {
                    HuberwayCMS.handleError(res.response.data)
                })
                .then(() => {
