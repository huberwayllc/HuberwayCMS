...
@push('footer')
    <script>
        ...
        HuberwayCMSVariables.languages = HuberwayCMSVariables.languages || {};
        HuberwayCMSVariables.languages.reports = {!! json_encode(trans('plugins/ecommerce::reports.ranges'), JSON_HEX_APOS) !!}
    </script>
@endpush
