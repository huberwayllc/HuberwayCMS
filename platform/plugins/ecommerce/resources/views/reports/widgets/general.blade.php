...
<ul class="ecommerce-status-list list-unstyled">
    ...
    <li class="out-of-stock">
        ...
        <a
            class="ms-2"
            href="{{ route('products.index') }}?filter_table_id=huberwaycms-ecommerce-tables-product-table&class=HuberwayCMS%5CEcommerce%5CTables%5CProductTable&filter_columns%5B%5D=stock_status&filter_operators%5B%5D=%3D&filter_values%5B%5D=out_of_stock">
