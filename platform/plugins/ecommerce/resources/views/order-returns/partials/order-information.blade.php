...
@if (
    $returnRequest->return_status != HuberwayCMS\Ecommerce\Enums\OrderReturnStatusEnum::COMPLETED
    || $returnRequest->return_status != HuberwayCMS\Ecommerce\Enums\OrderReturnStatusEnum::CANCELED
)
    <x-core::card>
        <x-core::card.header>
            <x-core::card.title>
        ...
        <x-core::card.body>
            ...
            >
                <x-core::form.select
                    ...
                    name="return_status"
                    :options="HuberwayCMS\Ecommerce\Enums\OrderReturnStatusEnum::labels()"
