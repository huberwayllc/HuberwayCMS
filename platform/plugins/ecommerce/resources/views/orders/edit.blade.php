            ...
            <div class="col-md-9">
                <x-core::card class="mb-3">
                            ...
                            <div class="col-md-6 offset-md-6">
                                <x-core::table :hover="false" :striped="false" class="table-borderless text-end">
                                    <x-core::table.body>
                                        ...
                                        <x-core::table.body.row>
                                            ...
                                            <x-core::table.body.cell>
                                                @if (is_plugin_active('payment') && $order->payment->id)
                                                    <span @class(['text-warning' => $order->payment->status != HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED]) class="text-warning">
                                            ...
                                            <x-core::table.body.cell>
                                                @if (is_plugin_active('payment') && $order->payment->id)
                                                    <a
                                                        ...
                                                        target="_blank"
                                                    >
                                                        <span>{{ format_price($order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->payment->amount : 0) }}</span>
                                                    </a>
                                                @else
                                                    <span>{{ format_price(is_plugin_active('payment') && $order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->payment->amount : 0) }}</span>
                                                @endif
                                            </x-core::table.body.cell>
                                        </x-core::table.body.row>
                                        ...
                                        @if (is_plugin_active('payment') && $order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::REFUNDED)
                                        ...
                                        <x-core::table.body.row class="hidden">
                                            ...
                                            <x-core::table.body.cell>
                                                {{ format_price(is_plugin_active('payment') && $order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->amount : 0) }}
                                            </x-core::table.body.cell>
                                        </x-core::table.body.row>
                                    </x-core::table.body>
                                </x-core::table>
                    ...
                    <div class="list-group list-group-flush">
                        @if ($order->status != HuberwayCMS\Ecommerce\Enums\OrderStatusEnum::CANCELED || $order->is_confirmed)
                        ...
                        @endif
                        @if ($order->status == HuberwayCMS\Ecommerce\Enums\OrderStatusEnum::CANCELED || is_plugin_active('payment') && $order->payment->id)
                            <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                                @if ($order->status == HuberwayCMS\Ecommerce\Enums\OrderStatusEnum::CANCELED)
                                    <div class="text-uppercase">
                                ...
                                @elseif (is_plugin_active('payment') && $order->payment->id)
                                    <div class="text-uppercase">
                                        @if (!$order->payment->status || $order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::PENDING)
                                            <x-core::icon name="ti ti-credit-card" />
                                        @elseif (
                                            $order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED
                                            || $order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::PENDING
                                        )
                                        ...
                                        @elseif ($order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED)
                                    ...
                                    <div class="btn-list">
                                        @if (!$order->payment->status || in_array($order->payment->status, [HuberwayCMS\Payment\Enums\PaymentStatusEnum::PENDING]))
                                            <x-core::button
                                                type="button"
                                                color="info"
                        ...
                        @if (EcommerceHelper::countDigitalProducts($order->products) != $order->products->count())
                            <div class="p-3 d-flex justify-content-between align-items-center">
                                @if ($order->status == HuberwayCMS\Ecommerce\Enums\OrderStatusEnum::CANCELED && !$order->shipment->id)
                                    <div class="text-uppercase">
                                        <x-core::icon name="ti ti-check" class="text-success" />
...
@pushif($order->status != HuberwayCMS\Ecommerce\Enums\OrderStatusEnum::CANCELED, 'footer')
    <x-core::modal.action
