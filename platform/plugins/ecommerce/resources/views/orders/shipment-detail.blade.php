...
@if ($shipment->status != HuberwayCMS\Ecommerce\Enums\ShippingStatusEnum::CANCELED && $order->status != HuberwayCMS\Ecommerce\Enums\OrderStatusEnum::CANCELED)
    <x-core::card.footer class="shipment-actions-wrapper btn-list">
        @if (in_array($shipment->status, [
            HuberwayCMS\Ecommerce\Enums\ShippingStatusEnum::NOT_APPROVED,
            HuberwayCMS\Ecommerce\Enums\ShippingStatusEnum::APPROVED,
        ]))
            <x-core::button
                type="button"
