...
use HuberwayCMS\Ecommerce\Cart\Cart as BaseCart;
use Illuminate\Support\Facades\Facade;

/**
 * @method static \HuberwayCMS\Ecommerce\Cart\Cart instance(string|null $instance = null)
 * @method static \Carbon\CarbonInterface|null getLastUpdatedAt()
 * @method static array|\HuberwayCMS\Ecommerce\Cart\CartItem add(mixed $id, mixed $name = null, int|float $qty = null, float $price = null, array $options = [])
 ...
 * @method static \HuberwayCMS\Ecommerce\Cart\Cart putToSession($content)
 * @method static void setLastUpdatedAt()
 * @method static \HuberwayCMS\Ecommerce\Cart\CartItem|bool update(string $rowId, mixed $qty)
 * @method static mixed updateQuietly($rowId, $qty)
 * @method static \HuberwayCMS\Ecommerce\Cart\CartItem|null get(string $rowId)
 ...
 *
 * @see \HuberwayCMS\Ecommerce\Cart\Cart
 */
