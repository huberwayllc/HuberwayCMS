...
use HuberwayCMS\Ecommerce\Http\Requests\AddAttributesToProductRequest;
use HuberwayCMS\Ecommerce\Http\Requests\CreateProductWhenCreatingOrderRequest;
use HuberwayCMS\Ecommerce\Http\Requests\DeleteProductVariationsRequest;
use HuberwayCMS\Ecommerce\Http\Requests\ProductListRequest;
use HuberwayCMS\Ecommerce\Http\Requests\ProductUpdateOrderByRequest;
use HuberwayCMS\Ecommerce\Http\Requests\ProductVersionRequest;
use HuberwayCMS\Ecommerce\Http\Requests\SearchProductAndVariationsRequest;
use HuberwayCMS\Ecommerce\Http\Resources\AvailableProductResource;
...
use HuberwayCMS\Ecommerce\Services\Products\CreateProductVariationsService;
