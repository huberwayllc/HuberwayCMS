...
namespace HuberwayCMS\Ecommerce\Cart;

use HuberwayCMS\Base\Enums\BaseStatusEnum;
use HuberwayCMS\Ecommerce\Cart\Contracts\Buyable;
use HuberwayCMS\Ecommerce\Cart\Exceptions\CartAlreadyStoredException;
use HuberwayCMS\Ecommerce\Cart\Exceptions\UnknownModelException;
...
class Cart
{
     ...
     * @param float $price
     * @param array $options
     * @return array|\HuberwayCMS\Ecommerce\Cart\CartItem
     */
     ...
     * @param float $price
     * @param array $options
     * @return \HuberwayCMS\Ecommerce\Cart\CartItem
     */
     ...
     * @param string $rowId
     * @param mixed $qty
     * @return \HuberwayCMS\Ecommerce\Cart\CartItem|bool
     */
     ...
     *
     * @param string $rowId
     * @return \HuberwayCMS\Ecommerce\Cart\CartItem|null
     */
