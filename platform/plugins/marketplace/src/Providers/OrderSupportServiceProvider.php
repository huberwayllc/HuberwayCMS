...
use HuberwayCMS\Ecommerce\Models\Order as OrderModel;
...
use HuberwayCMS\Marketplace\Models\CategoryCommission;
...
class OrderSupportServiceProvider extends ServiceProvider
{
    ...
    public function setEmailVariables(Collection $orders): \HuberwayCMS\Base\Supports\EmailHandler
    {
