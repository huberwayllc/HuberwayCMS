...
<x-core::card.footer class="shipment-actions-wrapper btn-list">
    @if (
        ...
        || in_array($shipment->status, [
            HuberwayCMS\Ecommerce\Enums\ShippingStatusEnum::PENDING,
            HuberwayCMS\Ecommerce\Enums\ShippingStatusEnum::APPROVED,
            HuberwayCMS\Ecommerce\Enums\ShippingStatusEnum::ARRANGE_SHIPMENT,
            HuberwayCMS\Ecommerce\Enums\ShippingStatusEnum::READY_TO_BE_SHIPPED_OUT,
        ])
    )
        <x-core::button
            type="button"
