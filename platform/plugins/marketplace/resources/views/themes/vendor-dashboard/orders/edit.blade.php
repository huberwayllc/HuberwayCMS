                                    ...
                                    <x-core::table.body>
                                        ...
                                        @if(is_plugin_active('payment'))
                                            <x-core::table.body.row>
                                                ...
                                                <x-core::table.body.cell>
                                                    {{ format_price($order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->payment->amount : 0) }}
                                                </x-core::table.body.cell>
                                            </x-core::table.body.row>
                                            @if ($order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::REFUNDED)
                                            ...
                                            <x-core::table.body.row class="hidden">
                                                ...
                                                <x-core::table.body.cell>
                                                    {{ format_price($order->payment->status == HuberwayCMS\Payment\Enums\PaymentStatusEnum::COMPLETED ? $order->amount : 0) }}
                                                </x-core::table.body.cell>
                                            </x-core::table.body.row>
                                        @endif
                                    </x-core::table.body>
