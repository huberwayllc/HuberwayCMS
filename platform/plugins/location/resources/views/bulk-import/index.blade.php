        ...
        <x-core::card.body>
            <x-core::form :url="route('location.bulk-import.import-location-data')" method="post" class="form-import-available-data">
                <x-core::form.select
                    ...
                    :options="$locations"
                    :searchable="true"
                    :helper-text="trans('plugins/location::bulk-import.available_data_help', ['link' => Html::link('https://github.com/huberwayllc/locations', attributes: ['target' => '_blank'])])"
                />
                ...
                <x-core::table>
                    ...
                    <x-core::table.body>
                        ...
                        <x-core::table.body.row>
                            ...
                            <x-core::table.body.cell>
                                (required|enum:{{ implode(',', HuberwayCMS\Base\Enums\BaseStatusEnum::values()) }}|default:{{ HuberwayCMS\Base\Enums\BaseStatusEnum::PUBLISHED }})
                            </x-core::table.body.cell>
                        </x-core::table.body.row>
                        <x-core::table.body.row>
                            <x-core::table.body.cell>
