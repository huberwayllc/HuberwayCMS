    ...
    <x-core::table :striped="false" :hover="false">
        <x-core::table.body>
            ...
            <x-core::table.body.cell style="width: 20%">
                <img
                    class="filter-black"
                    src="{{ url('vendor/core/plugins/shippo/images/logo-huberway-colore.svg') }}"
                    alt="Shippo"
                >
            </x-core::table.body.cell>
            <x-core::table.body.cell>
                                    ...
                                    <ul class="ps-3">
                                        <li style="list-style-type: circle;">
                                            <span>{!! BaseHelper::clean(
                                                trans('plugins/shippo::shippo.note_1', ['link' => 'https://support.huberway.com/farmart/1.x/usage-location']),
                                            ) !!}</span>
                                        </li>
                                        <li style="list-style-type: circle;">
