...
namespace HuberwayCMS\SeoHelper\Contracts;

use HuberwayCMS\SeoHelper\Contracts\Entities\AnalyticsContract;
use HuberwayCMS\SeoHelper\Contracts\Entities\DescriptionContract;
use HuberwayCMS\SeoHelper\Contracts\Entities\MiscTagsContract;
use HuberwayCMS\SeoHelper\Contracts\Entities\TitleContract;
use HuberwayCMS\SeoHelper\Contracts\Entities\WebmastersContract;
