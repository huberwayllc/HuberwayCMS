...
use HuberwayCMS\Theme\Theme as BaseTheme;
use Illuminate\Support\Facades\Facade;

/**
 * @method static \HuberwayCMS\Theme\Theme layout(string $layout)
 * @method static \HuberwayCMS\Theme\Theme uses(string|null $theme = null)
 * @method static \HuberwayCMS\Theme\Theme theme(string|null $theme = null)
 ...
 * @method static \HuberwayCMS\Theme\Theme setThemeName(string $theme)
 * @method static string getPublicThemeName()
 * @method static void fire(string $event, callable|object|array|string|null $args)
 * @method static \HuberwayCMS\Theme\Breadcrumb breadcrumb()
 * @method static \HuberwayCMS\Theme\Theme append(string $region, string $value)
 * @method static \HuberwayCMS\Theme\Theme set(string $region, mixed|null $value)
 * @method static \HuberwayCMS\Theme\Theme prepend(string $region, string $value)
 ...
 * @method static \HuberwayCMS\Theme\Asset|\HuberwayCMS\Theme\AssetContainer asset()
 * @method static \HuberwayCMS\Theme\Theme ofWithLayout(string $view, array $args = [])
 * @method static \HuberwayCMS\Theme\Theme of(string $view, array $args = [])
 * @method static mixed scope(string $view, array $args = [], $default = null)
 * @method static \HuberwayCMS\Theme\Theme setUpContent(string $view, array $args = [])
 * @method static \HuberwayCMS\Theme\Theme load(string $view, array $args = [])
 ...
 * @method static \HuberwayCMS\Theme\Theme fireEventGlobalAssets()
