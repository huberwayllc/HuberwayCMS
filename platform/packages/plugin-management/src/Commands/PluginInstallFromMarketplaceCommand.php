...
use HuberwayCMS\PluginManagement\Commands\Concern\HasPluginNameValidation;
use HuberwayCMS\PluginManagement\Services\MarketplaceService;
...
#[AsCommand('cms:plugin:install-from-marketplace', 'Install a plugin from https://marketplace.huberway.org')]
