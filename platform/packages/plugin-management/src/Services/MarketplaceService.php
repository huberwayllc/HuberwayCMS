...
namespace HuberwayCMS\PluginManagement\Services;
...
class MarketplaceService
{
    ...
    public function callApi(string $method, string $path, array $request = []): JsonResponse|Response
    {
        ...
        try {
            ...
            // Logga la risposta della chiamata API
            ...
            if ($response->status() !== 200) {
                ...
                return $this->responseReturn(
                    Arr::get($body, 'message') ?: $this->url . $path,
                    true,
                    [],
            ...
            return $this->responseReturn(trans(''), true);
        }
    }
