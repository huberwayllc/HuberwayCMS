...
@section('content')
    <div role="alert" class="alert alert-warning">
        Those plugins are from our HuberwayCMS community <a href="https://marketplace.huberway.org/products" target="_blank">marketplace.huberway.com/products</a>. We regret to inform
...
@push('footer')
    ...
    >
        <div class="text-start">
            <p>
                You are installing plugin from our HuberwayCMS community. Those plugins are developed by author
                on <a href="https://marketplace.huberway.org" target="_blank">marketplace.huberway.com</a>.
            </p>
            <p>We (HuberwayCMS) <strong>won't</strong> support free plugins from Marketplace.</p>
            <p>
