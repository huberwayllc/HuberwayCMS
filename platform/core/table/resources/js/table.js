;(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.excel',
                HuberwayCMSVariables.languages.tables.excel ? HuberwayCMSVariables.languages.tables.excel : 'Excel'
            )}`
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.export',
                HuberwayCMSVariables.languages.tables.export ? HuberwayCMSVariables.languages.tables.export : 'Export'
            )}`
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.csv',
                HuberwayCMSVariables.languages.tables.csv ? HuberwayCMSVariables.languages.tables.csv : 'CSV'
            )}`
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: (dt) => {
            return `<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                ${dt.i18n(
                    'buttons.print',
                    HuberwayCMSVariables.languages.tables.print ? HuberwayCMSVariables.languages.tables.print : 'Print'
                )}`
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return `<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                ${dt.i18n(
                    'buttons.reset',
                    HuberwayCMSVariables.languages.tables.reset ? HuberwayCMSVariables.languages.tables.reset : 'Reset'
                )}`
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return `
                ...
                ${dt.i18n(
                    'buttons.reload',
                    HuberwayCMSVariables.languages.tables.reload ? HuberwayCMSVariables.languages.tables.reload : 'Reload'
                )}`
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', (event) => {
                ...
                if (ids.length === 0) {
                    HuberwayCMS.showError(
                        HuberwayCMSVariables.languages.tables.please_select_record
                            ? HuberwayCMSVariables.languages.tables.please_select_record
