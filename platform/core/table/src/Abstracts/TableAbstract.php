...
namespace HuberwayCMS\Table\Abstracts;

use HuberwayCMS\ACL\Models\User;
use HuberwayCMS\Base\Contracts\BaseModel as BaseModelContract;
use HuberwayCMS\Base\Contracts\Builders\Extensible as ExtensibleContract;
use HuberwayCMS\Base\Facades\Assets;
use HuberwayCMS\Base\Facades\BaseHelper;
use HuberwayCMS\Base\Facades\Form;
use HuberwayCMS\Base\Facades\Html;
use HuberwayCMS\Base\Models\BaseModel;
use HuberwayCMS\Base\Supports\Builders\Extensible;
use HuberwayCMS\Base\Supports\Builders\RenderingExtensible;
use HuberwayCMS\Table\Abstracts\Concerns\DeprecatedFunctions;
use HuberwayCMS\Table\Abstracts\Concerns\HasActions;
use HuberwayCMS\Table\Abstracts\Concerns\HasBulkActions;
use HuberwayCMS\Table\Abstracts\Concerns\HasFilters;
use HuberwayCMS\Table\Abstracts\Concerns\HasHeaderActions;
use HuberwayCMS\Table\Columns\CheckboxColumn;
use HuberwayCMS\Table\Columns\Column;
use HuberwayCMS\Table\Columns\RowActionsColumn;
use HuberwayCMS\Table\Contracts\FormattedColumn;
use HuberwayCMS\Table\HeaderActions\HeaderAction;
use HuberwayCMS\Table\Supports\Builder as CustomTableBuilder;
...
abstract class TableAbstract extends DataTable implements ExtensibleContract
{
    ...
    /**
     * @var \HuberwayCMS\Table\Columns\Column[]
     */
    ...
    /**
     * @param \HuberwayCMS\Table\Columns\Column[] $columns
     */
