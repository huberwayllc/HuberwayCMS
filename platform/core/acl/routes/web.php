...
use HuberwayCMS\ACL\Http\Controllers\Auth\ForgotPasswordController;
use HuberwayCMS\ACL\Http\Controllers\Auth\LoginController;
use HuberwayCMS\ACL\Http\Controllers\Auth\ResetPasswordController;
use HuberwayCMS\ACL\Http\Middleware\CheckUserUpdatePermission;
use HuberwayCMS\Base\Facades\AdminHelper;
use Illuminate\Support\Facades\Route;

Route::group(['namespace' => 'HuberwayCMS\ACL\Http\Controllers'], function () {
