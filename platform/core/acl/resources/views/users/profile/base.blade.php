...
@if ($canChangeProfile)
    @push('footer')
        {!! JsValidator::formRequest(HuberwayCMS\ACL\Http\Requests\UpdateProfileRequest::class, '#profile-form') !!}
        {!! JsValidator::formRequest(HuberwayCMS\ACL\Http\Requests\UpdatePasswordRequest::class, '#password-form') !!}
    @endpush
@endif
