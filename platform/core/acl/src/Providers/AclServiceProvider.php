...
use HuberwayCMS\ACL\Http\Middleware\Authenticate;
use HuberwayCMS\ACL\Http\Middleware\RedirectIfAuthenticated;
use HuberwayCMS\ACL\Models\Activation;
use HuberwayCMS\ACL\Models\Role;
use HuberwayCMS\ACL\Models\User;
use HuberwayCMS\ACL\Repositories\Eloquent\ActivationRepository;
use HuberwayCMS\ACL\Repositories\Eloquent\RoleRepository;
use HuberwayCMS\ACL\Repositories\Eloquent\UserRepository;
use HuberwayCMS\ACL\Repositories\Interfaces\ActivationInterface;
