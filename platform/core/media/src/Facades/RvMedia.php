...
namespace HuberwayCMS\Media\Facades;

use HuberwayCMS\Media\RvMedia as BaseRvMedia;
 ...
 * @method static bool deleteFile(\HuberwayCMS\Media\Models\MediaFile $file)
 * @method static bool deleteThumbnails(\HuberwayCMS\Media\Models\MediaFile $file)
 ...
 * @method static \HuberwayCMS\Media\RvMedia addSize(string $name, string|int $width, string|int $height = 'auto')
 * @method static \HuberwayCMS\Media\RvMedia removeSize(string $name)
 ...
 * @method static bool generateThumbnails(\HuberwayCMS\Media\Models\MediaFile $file, \Illuminate\Http\UploadedFile|null $fileUpload = null)
 ...
 * @method static void renameFile(\HuberwayCMS\Media\Models\MediaFile $file, string $newName, bool $renameOnDisk = true)
 * @method static void renameFolder(\HuberwayCMS\Media\Models\MediaFolder $folder, string $newName, bool $renameOnDisk = true)
