...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => HuberwayCMS.showButtonLoading(element))
        this.completed(() => HuberwayCMS.hideButtonLoading(element))

        return this
    }

    withLoading(element) {
        this.beforeSend(() => HuberwayCMS.showLoading(element))
        this.completed(() => HuberwayCMS.hideLoading(element))
    ...
    withDefaultErrorHandler() {
        this.errorHandlerUsing((error) => {
            ...
            switch (statusCode) {
                case 419:
                    HuberwayCMS.showError('Session expired this page will reload in 5s.')
