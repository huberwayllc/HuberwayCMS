...
use HuberwayCMS\Base\Events\LicenseActivated;
use HuberwayCMS\Base\Events\LicenseActivating;
use HuberwayCMS\Base\Events\LicenseDeactivated;
use HuberwayCMS\Base\Events\LicenseDeactivating;
use HuberwayCMS\Base\Events\LicenseInvalid;
use HuberwayCMS\Base\Events\LicenseRevoked;
use HuberwayCMS\Base\Events\LicenseRevoking;
use HuberwayCMS\Base\Events\LicenseUnverified;
use HuberwayCMS\Base\Events\LicenseVerified;
use HuberwayCMS\Base\Events\LicenseVerifying;
use HuberwayCMS\Base\Events\SystemUpdateAvailable;
use HuberwayCMS\Base\Events\SystemUpdateCachesCleared;
use HuberwayCMS\Base\Events\SystemUpdateCachesClearing;
use HuberwayCMS\Base\Events\SystemUpdateChecked;
use HuberwayCMS\Base\Events\SystemUpdateChecking;
use HuberwayCMS\Base\Events\SystemUpdateDBMigrated;
use HuberwayCMS\Base\Events\SystemUpdateDBMigrating;
use HuberwayCMS\Base\Events\SystemUpdateDownloaded;
use HuberwayCMS\Base\Events\SystemUpdateDownloading;
use HuberwayCMS\Base\Events\SystemUpdateExtractedFiles;
use HuberwayCMS\Base\Events\SystemUpdatePublished;
use HuberwayCMS\Base\Events\SystemUpdatePublishing;
use HuberwayCMS\Base\Events\SystemUpdateUnavailable;
...
use HuberwayCMS\Base\Exceptions\MissingCURLExtensionException;
use HuberwayCMS\Base\Exceptions\MissingZipExtensionException;
use HuberwayCMS\Base\Exceptions\RequiresLicenseActivatedException;
use HuberwayCMS\Base\Facades\BaseHelper;
use HuberwayCMS\Base\Services\ClearCacheService;
...
final class Core
{
    ...
    private string $licenseUrl = 'https://api.huberway.com';
    ...
    /**
     * @throws \HuberwayCMS\Base\Exceptions\LicenseInvalidException
     * @throws \HuberwayCMS\Base\Exceptions\LicenseIsAlreadyActivatedException
     */
