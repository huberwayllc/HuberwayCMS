...
use HuberwayCMS\Base\Rules\DomainRule;
use HuberwayCMS\Setting\Forms\EmailRulesSettingForm;
use HuberwayCMS\Setting\Http\Requests\EmailRulesSettingRequest;
