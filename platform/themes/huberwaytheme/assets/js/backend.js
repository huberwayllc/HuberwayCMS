(function($) {
    ...
    window.huberwaycmsCookieNewsletter = (() => {

        const COOKIE_VALUE = 1
        const COOKIE_NAME = 'huberway_cookie_newsletter'
    ...
    $(document).ready(function() {
        ...
        $('.ps-popup__close').on('click', function(e) {
            ...
            window.huberwaycmsCookieNewsletter.hideCookieDialog()
        })
        ...
        $(document).on('click', '.newsletter-form button[type=submit]', function(event) {
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    if (!res.error) {
                        window.huberwaycmsCookieNewsletter.newsletterWithCookies(30)
