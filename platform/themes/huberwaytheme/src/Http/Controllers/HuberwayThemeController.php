...
namespace Theme\HuberwayTheme\Http\Controllers;
...
use HuberwayCMS\Theme\Http\Controllers\PublicController;
use Illuminate\Http\Request;
use Theme\HuberwayTheme\Http\Requests\SendDownloadAppLinksRequest;

class HuberwayThemeController extends PublicController
{
